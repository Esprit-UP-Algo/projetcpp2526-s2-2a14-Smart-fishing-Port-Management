...
QFrame* LivraisonWindow::createStatsArea()
{
    ...
    totalCard->setStyleSheet("background-color: white; border: 2px solid #5D9CEC; border-radius: 20px;");
    ...
    totalTitle->setStyleSheet("color: #5A6C7D; font-family: 'Segoe UI'; font-size: 11pt; font-weight: 600;");
    totalDeliveriesLabel = new QLabel("0");
    totalDeliveriesLabel->setStyleSheet("color: #2C3E50; font-family: 'Segoe UI'; font-size: 24pt; font-weight: bold;");
    totalLabels->addWidget(totalTitle);
    totalLabels->addWidget(totalDeliveriesLabel);
    
    QLabel* totalIcon = new QLabel("📦");
    totalIcon->setStyleSheet("font-size: 28pt;");
    ...
    efficiencyCard->setStyleSheet("background-color: white; border: 2px solid #5D9CEC; border-radius: 20px;");
    ...
    effTitle->setStyleSheet("color: #5A6C7D; font-family: 'Segoe UI'; font-size: 11pt; font-weight: 600;");
    efficiencyLabel = new QLabel("0%");
    efficiencyLabel->setStyleSheet("color: #2C3E50; font-family: 'Segoe UI'; font-size: 24pt; font-weight: bold;");
    effLabels->addWidget(effTitle);
    effLabels->addWidget(efficiencyLabel);
    
    QLabel* effIcon = new QLabel("📈");
    effIcon->setStyleSheet("font-size: 28pt;");
...
QWidget* LivraisonWindow::createStatusBadge(const QString& status)
{
    ...
    QString badgeStyle = "padding: 0 15px; border-radius: 15px; font-weight: bold; font-size: 10pt; ";
    if (status == "Livré") {
        badgeStyle += "background-color: #dcfce7; color: #15803d;";
    } else if (status == "En cours") {
        badgeStyle += "background-color: #fef9c3; color: #a16207;";
    } else {
...
QWidget* LivraisonWindow::createActionButtons(int row)
{
    ...
    editBtn->setStyleSheet("QPushButton { border: none; border-radius: 8px; font-size: 14pt; background-color: #fef3c7; }"
                           "QPushButton:hover { background-color: #fde68a; }"
                           "QPushButton:pressed { background-color: #fcd34d; }");
    deleteBtn->setStyleSheet("QPushButton { border: none; border-radius: 8px; font-size: 14pt; background-color: #fee2e2; }"
                             "QPushButton:hover { background-color: #fecaca; }"
                             "QPushButton:pressed { background-color: #fca5a5; }");
    pdfBtn->setStyleSheet("QPushButton { border: none; border-radius: 8px; font-size: 14pt; background-color: #dcfce7; }"
