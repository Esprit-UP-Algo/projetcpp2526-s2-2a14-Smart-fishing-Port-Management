...
constexpr auto qt_meta_stringdata_CLASSEmployeeWindowENDCLASS = QtMocHelpers::stringData(
    ...
    "onSort",
    "index",
    "onReglementInterieur",
    "onDemandeConge",
    "onAttestationTravail",
    "onViewStats",
    "toggleDarkMode"
);
...
Q_CONSTINIT const QMetaObject EmployeeWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSEmployeeWindowENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'onReglementInterieur'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onDemandeConge'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onAttestationTravail'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onViewStats'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void EmployeeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onEditEmployee((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->onDeleteEmployee((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 4: _t->onLogout(); break;
        case 5: _t->onSort((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 6: _t->onReglementInterieur(); break;
        case 7: _t->onDemandeConge(); break;
        case 8: _t->onAttestationTravail(); break;
        case 9: _t->onViewStats(); break;
