    ...
    : QMainWindow(parent)
{
    ...
    Frigo f1{"FR001", "REF-001", "800", "65", "-4", "Disponible", "Sardine"};
    Frigo f2{"FR002", "REF-002", "1200", "72", "-6", "Occupé", "Thon"};
    Frigo f3{"FR003", "REF-003", "600", "60", "-3", "Disponible", "Crevette"};
    Frigo f4{"FR004", "REF-004", "1000", "68", "-5", "Maintenance", "Merlan"};
