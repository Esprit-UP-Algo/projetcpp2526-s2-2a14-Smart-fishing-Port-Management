...
QFrame* MainWindow::createSidebar()
{
    ...
    if (role.compare("Marin", Qt::CaseInsensitive) != 0 && role.compare("Admin", Qt::CaseInsensitive) != 0 && !role.isEmpty()) bateauxBtn->hide();
    ...
    if (role.compare("Pêcheur", Qt::CaseInsensitive) != 0 && role.compare("Admin", Qt::CaseInsensitive) != 0 && !role.isEmpty()) pechesBtn->hide();
    ...
    if (role.compare("RH", Qt::CaseInsensitive) != 0 && role.compare("Admin", Qt::CaseInsensitive) != 0 && !role.isEmpty()) employeesBtn->hide();
    ...
    if (role.compare("Technicien", Qt::CaseInsensitive) != 0 && role.compare("Admin", Qt::CaseInsensitive) != 0 && !role.isEmpty()) {
        frigosBtn->hide();
        frigoNotifyLabel1->hide();
        frigoNotifyLabel2->hide();
    }
    ...
    if (role.compare("Livreur", Qt::CaseInsensitive) != 0 && role.compare("Admin", Qt::CaseInsensitive) != 0 && !role.isEmpty()) livraisonBtn->hide();
    ...
    if (role.compare("Sécurité", Qt::CaseInsensitive) != 0 && role.compare("Admin", Qt::CaseInsensitive) != 0 && !role.isEmpty()) quaisBtn->hide();
