...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSStatisticsDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSStatisticsDialogENDCLASS = QtMocHelpers::stringData(
    "StatisticsDialog"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_CLASSStatisticsDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject StatisticsDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_CLASSStatisticsDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSStatisticsDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSStatisticsDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<StatisticsDialog, std::true_type>
    >,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSStatisticsDialogENDCLASS.stringdata0))
        return static_cast<void*>(this);
